...
function home() {
  ...
  <div class="w-100 bg-light p-5 rounded text-center">
      ...
      <button onclick='showLogin()' class="form-control btn btn-dark">Logout</button><br>
      <p><br><select id="type" class="form-control" onchange='showUser()'>
...
<div class="card text-center">
  ...
  <div class="card-body">
    <h5 class="card-title">Welcome! Your financial journey starts here!</h5>
    <p class="card-text">We are committed to providing secure, convenient, and innovative banking solutions to help you manage your finances with ease. From savings and loans to digital banking, we’re here to support your financial goals every step of the way.</p>
